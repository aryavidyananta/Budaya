...
if (isset($_POST['add'])){
    ...
    {
        global $connect;
        $sql = mysqli_query($connect, "UPDATE upload SET Judul='".$_POST['judul']."',Isi='".$_POST['isi']."',Kategori='".$_POST['Kategori'].',gambar='.$gambar."',Teks='".$_POST['teks']."',Terbit='".$_POST['terbit']."' WHERE ID='".$_POST['id']."' ");
...
if(isset($_GET['act']) && $_GET['act']=='edit'){
    ...
    while($b = mysqli_fetch_array($sql)){
        ...
        $hapus = mysqli_query($connect,"DELETE FROM upload WHERE ID='$ID' ");
...
?>
        ...
        <input type="submit" name="add" value="<?=isset($b['ID']) ? 'Edit' : 'Tambah'?>" class="btn-primary">
